...
<body>
	...
	<div class="page-title-box">
		<div class="page-title-right">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item"><a href="javascript:location.href='//mcaBoard?boardDvsn=3';">복지몰 건의사항</a></li>
				<li class="breadcrumb-item active">복지몰 건의사항 수정</li>
			</ol>
		</div>
		<h2 class="page-title">복지몰 건의사항 수정</h2>
	</div>
	...
	<div class="card-body">
		...
		<c:forEach var="row" items="${list}">	
			<form method="post" action="/mcaBoardEditPost">
				<div class="card">
