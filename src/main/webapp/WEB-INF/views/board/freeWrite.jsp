...
<body>
	...
	<div class="page-title-box">
		<div class="page-title-right">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item active">자유 게시글 작성</li>
			</ol>
		</div>
	...
	<div class="card-body">
		<div class="row mb-2" style="position: relative; right: 20px;">
			...
			<!-- 게시글 작성 폼 시작 -->
			<form method="post" action="/freeWritePost">
				<div class="container">
					<div class="row">
						<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
							<thead>
								<tr>
									<th colspan="2" style="background-color: #eeeeee; text-align: center;">자유 게시글</th>
								</tr>
								<tr>
									<td>
										<input type="text" class="form-control" value="1" name="boardDvsn" style="display: none;">	
									</td>
								</tr>
								<tr>
									<td>
