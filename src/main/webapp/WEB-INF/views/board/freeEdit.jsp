...
<body>
	...
	<div class="page-title-box">
		<div class="page-title-right">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item"><a href="javascript:location.href='/free';">자유게시판</a></li>
				<li class="breadcrumb-item active">자유 게시글 수정</li>
			</ol>
		</div>
		<h2 class="page-title">자유 게시판 수정</h2>
	</div>
	...
	<div class="card-body">
		...
		<c:forEach var="row" items="${list}">
			<form method="post" action="/freeEditPost">
				<div class="card">
					<div class="card-body pb-1">
						<div class="media">
							...
							<div class="media-body">
								<input type="text" placeholder="${row.boardTitle}" name="boardTitle" /><br />
								...
								<p class="text-muted">
									<small><span>${row.boardWrdate}</span></small>
								</p>
							</div>
						</div>
