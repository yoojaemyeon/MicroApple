   ...
   <div class="page-title-box">
      <div class="page-title-right">
         <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item">회의록</li>
         </ol>
      </div>
...
<!--                <button type="button" class="btn btn-secondary" onclick="javascript:location.href='/free';">등록</button> -->
            </div>
         </div>
         <!-- end col-->
      </div>
      ...
      <!-- 게시글 작성 폼 시작 -->
      <form method="post" action="/ConferenceWrite" enctype="multipart/form-data">
         <div class="container">
            <div class="row">
                  ...
                  <thead>
                     ...
                     <tr>
                        <td>
                          ...
                          <input type="text" class="form-control" placeholder="회의 제목" name="mtngTitle">
                        </td>
                     </tr>
                     <tr>
                        <td>
                     ...
                     <tr>
                        <td>
                           <input type="text" class="form-control" placeholder="회의 결과" name="mtngResults">
                        </td>
                     </tr>
                     <tr>
                        <td>
                           <textarea id="summernote-basic" name="mtngCont"></textarea>
                        </td>
                     </tr>
                  </thead>
               </table>
      ...
      <div class="text-lg-right" style="position: relative; right: 220px;">
