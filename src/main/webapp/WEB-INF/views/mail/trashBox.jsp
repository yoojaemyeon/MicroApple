...
function formSubmit2(p_num) {
	...
	$("#K_checkbox").attr("action", "<%=request.getContextPath()%>/deleteComplete");
	button.submit();
						                   ...
						                   <li class="unread">
						                       ...
						                       <div class="email-action-icons">
						                           <ul class="list-inline">
						                               ...
						                               <li class="list-inline-item">
						                                   <a href="javascript:void(0);" class="button" onclick="formSubmit2(${listPage.emIdx}); return false;" id="${status.index}"><i class="mdi mdi-delete email-action-icons-item"></i></a>
						                               </li>
						                           </ul>
						                       </div>
						                   </li>
