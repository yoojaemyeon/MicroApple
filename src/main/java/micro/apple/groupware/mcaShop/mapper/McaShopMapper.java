package micro.apple.groupware.mcaShop.mapper;
...
public interface McaShopMapper {
   ...
   //상품 이미지 수정 POST
   public int updateImage(List<Map<String, Object>> list);
   ...
   //주문내역 삭제
   int deleteOrlist(Map<String, Object> map);
